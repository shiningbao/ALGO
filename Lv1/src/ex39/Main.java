...
public class Main { 
	...
	public static void main(String[] args) {
		...
		result = sol.solution(new int[] {1, 3, 4, 6}); 
		System.out.println("1223330333221=="+result);
		
		result = sol.solution(new int[] {1, 7, 1, 2}); 
		System.out.println("111303111=="+result);
		
		result = sol.solution(new int[] {1, 1, 2, 3}); 
		System.out.println("23032=="+result);
	}
	
}

class Solution {
    public String solution(int[] food) { // 0.04ms ~ 1.46ms
        ...
        /*	2.02ms ~ 3.17ms 성능은 비슷하지만 가독성이 훨씬 좋다.
