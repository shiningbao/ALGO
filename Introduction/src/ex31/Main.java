...
public class Main {
	...
	public static void main(String[] args) {
		...
		result = sol.solution(new int[]{1, 2, 3, 4}, 2); 
		System.out.println("3=="+result); 

		result = sol.solution(new int[]{1, 2, 3, 4, 5, 6}, 5); 
		System.out.println("3=="+result); 
		
		result = sol.solution(new int[]{1, 2, 3}, 3); 
		System.out.println("2=="+result); 
	}
}

class Solution {
    public int solution(int[] numbers, int k) { // 0.01ms ~ 0.03ms 
